        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-muted-foreground">
                    Bloco {ambiente.localizacao.bloco} • Unidade {ambiente.localizacao.unidade} •
                    Andar {ambiente.localizacao.andar}
                </p>
                <p className="text-sm">Tipo: {ambiente.tipo} • Capacidade: {ambiente.capacidade} •
                    Área: {ambiente.areaAmbiente.toFixed(2)} m²</p>
            ...
            <div>
                ...
                <ul className="text-sm list-disc pl-6">
                    {ambiente.esquadriasDetalhes.esquadrias.map((e) => (
                        <li key={e.id}>
                            {e.tipo} {e.geometria.base}x{e.geometria.altura}m
                            — {e.material} (área {e.area.toFixed(2)} m²)

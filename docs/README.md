...
- **Autenticação:** OAuth2 Authorization Code com PKCE + Google como provedor; backend como broker; JWT próprio (RSA) para acesso à API; refresh token em cookie HttpOnly.
